...
local resourceName = "wasabi_nfc"

if Config.checkForUpdates then
    CreateThread(function()
        if GetCurrentResourceName() ~= "wasabi_nfc" then
            resourceName = "wasabi_nfc (" .. GetCurrentResourceName() .. ")"
        end
    end)

    CreateThread(function()
        while true do
            PerformHttpRequest("https://api.github.com/repos/wasabirobby/wasabi_nfc/releases/latest", CheckVersion, "GET")
            Wait(3600000)
        end
    end)
    ...
    GetRepoInformations = function()
        ...
        PerformHttpRequest("https://api.github.com/repos/wasabirobby/wasabi_nfc/releases/latest", function(err, response, headers)
            if err == 200 then
                ...
                repoURL = "https://github.com/wasabirobby/wasabi_nfc"
            end
        end, "GET")
